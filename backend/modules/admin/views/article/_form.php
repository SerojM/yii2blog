...
<div class="article-form">
    ...
    <div class="second_select" style="display: none">
        ...
        <?php echo $form->field($model, 'sub_category')->dropDownList([], $second_params); ?>

    </div>
    <label> Tags For Article </label>
    <?= Html::dropDownList('tags', $selectedTags, $tags, ['class' => 'form-control', 'multiple' => true,'prompt'=>'Without tags']) ?>
